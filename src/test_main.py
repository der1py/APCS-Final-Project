...
with open("src/output/master_timetable.pkl", "rb") as f:
    master_timetable = pickle.load(f)
...
course_per_block = calculate_courses_per_block(master_timetable.sections, master_timetable.section_to_block)
block_balance_difference = calculate_block_balance_difference(course_per_block)
...
print(f"Course per block:  {format_courses_per_block(course_per_block)}")
